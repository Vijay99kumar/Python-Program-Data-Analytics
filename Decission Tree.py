# -*- coding: utf-8 -*-
"""
Created on Fri Jan 21 19:39:08 2022
...
dataset1 = pd.read_csv('D:\Pyhton data\Purchase_History.csv')
...
classifier = DecisionTreeClassifier(criterion = 'entropy',max_depth = 5, min_samples_leaf=3)
